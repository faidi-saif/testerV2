...
# sce_runner.run_scenario('./scenarios/example.json')
# ------------------------------------------------- reset --------------------------------------------
#sce_runner.run_scenario('./scenarios/reset.json')
# ------------------------------------------------- V0 --------------------------------------------
...
#sce_runner.get_test_result(result_path='/home/saif/PycharmProjects/testerv2/test_result.json')

#sce_runner.vcamera.reset('soft')


#vcam.flash('arduino','spherical')
